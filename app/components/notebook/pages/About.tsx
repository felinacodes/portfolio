...
export const aboutBlocks = (args?: RenderContext) => {
  ...
  return [
    <section
      id="about"
      key="about-me"
      // className="text-gray-900 flex flex-col items-center justify-start h-full w-full p-2 gap-2 "
      ...
      <div className="page-text-wrapper text-[0.9rem] sm:text-[1rem]  xl:text-[1.2rem] leading-snug max-w-[65ch] space-y-2  lg:space-y-4">
        <div key="intro">
          ...
          <p>
            ...
            interactive and responsive user interfaces using React and Next.js.
            I like creating websites and web apps that are unique and don&apos;t
            look like another template site.
          </p>
        </div>
        <p>
          As long as I can remember, I have always been fascinated by the world
          of computers and technology. I want to understand how things work
          under the hood and how they can be improved. This led me to pursue a
          degree in Computer Engineering, alongside specializing in Web
          Development on my own by following various sources and courses and
    ...
    <section
      key="developing"
      className=" section-wrapper page-text-wrapper-not-first text-[0.9rem] sm:text-[1rem]  xl:text-[1.2rem] leading-snug max-w-[65ch] space-y-2  lg:space-y-4"
    >
      <p className="mt-4">
      ...
      <p>
        Full-stack development is also something I enjoy. I have experience with
        Node.js and Express for building APIs, and I am also learning about
        databases and server management. Having shipped a few full-stack
    ...
    <section key="client" className="section-wrapper">
      <div className=" text-[0.9rem] sm:text-[1rem] xl:text-[1.2rem] leading-snug max-w-[65ch] space-y-2 lg:space-y-4">
        <p className="mt-4">
          ...
          understand their needs and create the best possible solution for them
          (it&apos;s not always React). I aim to be transparent and
